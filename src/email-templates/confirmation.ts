export const CONFIRMATION_EMAIL = `<!DOCTYPE html>
        ...
        <table class="sm-w-full" style="width: 600px" cellpadding="0" cellspacing="0" role="presentation">
          <tr>
            <td class="sm-pb-3" style="padding-bottom: 24px; text-align: center">
              <h1 style="font-size: 24px; font-weight: 600; color: #000">Wilkommen zum T3-notifier!</h1>
            </td>
          </tr>
          <tr>
              ...
              <table class="sm-w-full" style="width: 75%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td class="sm-px-6" style="background-color: #fff; padding: 48px; text-align: center">
                    <p style="margin: 0; font-size: 18px; font-weight: 600; color: #374151">Hey!</p>
                    <p style="font-size: 16px; color: #374151">Wir werden dir täglich informieren falls es neue Warhammer 40k auf T3 gibt.</p>
                    <p style="font-size: 16px; color: #374151">Viel Spass beim Zocken!</p>
                  </td>
                </tr>
                <tr>
